...
#define kJSPatchAppKey          @"c90ee17c604decbf"
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [JSPatch setupCallback:^(JPCallbackType type, NSDictionary *data, NSError *error) {
        ...
        NSString *testString = [[NSString alloc]initWithData:[data objectForKey:@"scriptData"] encoding:NSUTF8StringEncoding];
...
//        NSString *sourcePath = [[[NSBundle mainBundle] bundlePath] stringByAppendingPathComponent:@"dribbble/main.js"];
        ...
        [JPEngine evaluateScriptWithPath:testString];
